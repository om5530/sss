...
const cakeRequestSchema = new mongoose.Schema(
  {
    ...
    orderItems: { type: String, trim: true, maxlength: 200, default: '' },
    quantity: { type: String, trim: true, maxlength: 100, default: '' },
    occasion: { type: String, trim: true, maxlength: 60, default: '' },
    servings: { type: Number, min: 1, max: 500 },
    flavour: { type: String, trim: true, maxlength: 80, default: '' },
